      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 text-center z-10">
        <div className="max-w-4xl space-y-3 sm:space-y-4 md:space-y-5">
          <h1 className="text-[36px] sm:text-[40px] md:text-[52px] lg:text-[64px] font-bold text-white tracking-[-0.02em] drop-shadow-[0_4px_12px_rgba(0,0,0,0.4)] leading-[1.1]">
            Plant capital.<br/>
            Grow <span className="inline-block min-w-[180px] sm:min-w-[220px] lg:min-w-[280px] text-left text-emerald-400" data-testid="typewriter-text">{displayText}<span className="animate-pulse">|</span></span> impact.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center pt-8 md:pt-12 w-full px-2 sm:px-0">
            <button
              ...
              className="group relative w-full sm:min-w-[320px] lg:min-w-[400px] bg-blue-600 text-white px-6 sm:px-8 py-4 sm:py-5 rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-[3px] active:translate-y-[-1px] shadow-[0_4px_12px_rgba(37,99,235,0.3),0_2px_4px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_24px_rgba(37,99,235,0.4),0_4px_8px_rgba(0,0,0,0.15)]"
              data-testid="button-become-primer"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative flex flex-col gap-2">
                <span className="text-[18px] sm:text-[20px] font-bold">Become a Primer</span>
                <span className="text-[13px] sm:text-[14px] font-normal opacity-95 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-5 sm:gap-9 justify-center pt-10 sm:pt-14 text-white">
            <div className="flex items-center gap-2.5 px-4 py-2.5 bg-black/20 backdrop-blur-[4px] rounded-lg transition-transform duration-200 hover:-translate-y-0.5" data-testid="badge-blockchain">
              <Shield className="w-5 h-5 sm:w-6 sm:h-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]" />
              <span className="text-[14px] sm:text-[16px] font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Blockchain Verified</span>
            </div>
            <div className="flex items-center gap-2.5 px-4 py-2.5 bg-black/20 backdrop-blur-[4px] rounded-lg transition-transform duration-200 hover:-translate-y-0.5" data-testid="badge-global">
              <Globe className="w-5 h-5 sm:w-6 sm:h-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]" />
              <span className="text-[14px] sm:text-[16px] font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Trusted Globally</span>
            </div>
            <div className="flex items-center gap-2.5 px-4 py-2.5 bg-black/20 backdrop-blur-[4px] rounded-lg transition-transform duration-200 hover:-translate-y-0.5" data-testid="badge-pipeline">
              <Sprout className="w-5 h-5 sm:w-6 sm:h-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]" />
              <span className="text-[14px] sm:text-[16px] font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Farm-to-Token Pipeline</span>
            </div>
            <div className="flex items-center gap-2.5 px-4 py-2.5 bg-black/20 backdrop-blur-[4px] rounded-lg transition-transform duration-200 hover:-translate-y-0.5" data-testid="badge-regenerative">
              <Leaf className="w-5 h-5 sm:w-6 sm:h-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]" />
              <span className="text-[14px] sm:text-[16px] font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Regenerative Capital Model</span>
            </div>
          </div>
        </div>
      </div>
