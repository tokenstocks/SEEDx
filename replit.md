...
- **FAQ Section:** Comprehensive educational FAQ with 15 questions across 4 categories (Getting Started, Financial, Technical, Legal & Compliance). Features category filtering, Shadcn Accordion component, Framer Motion animations with reduced motion support, highlighted risk disclosures, fee tables, and "Still Have Questions?" CTA. Uses more flexible, natural language (including terms like "investment" and "returns") for educational clarity while maintaining legal disclaimers throughout.
